...
#*******************************************************************
'''
File name: PID_Control_v3.py
Description: This program implements a Modbus TCP client running as polling.
    This model is recommemded to variable setpoint control.
URL to Download:
...
Other Notes:
    ...
    * To run
        ...
        sudo /home/leandro/Dev/py3-10_modbusTCP/bin/python3 ./PID_Control_v3.py
    * This model performed to lower setpoint influence on PID output.
